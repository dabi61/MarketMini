...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 25, 2025 lúc 08:04 AM
...
(10, 'binh', '1', 'binh', 'Nam', 1, '0382951529', 'binh@gmail.com', '2025-06-25');
...
INSERT INTO `salary` (`salary_id`, `employee_id`, `total_hours`, `hourly_wage`, `bonus`, `penalty_deduction`, `gross_salary`, `net_salary`, `payment_date`, `created_date`) VALUES
(1, 1, 0.00, 30000, 0, 0, 0.00, 0.00, '2025-06-24', '2025-06-24'),
(2, 2, 0.00, 18000, 200000, 0, 200000.00, 200000.00, NULL, '2025-06-24'),
(3, 4, 0.00, 18000, 0, 0, 0.00, 0.00, NULL, '2025-06-24'),
(4, 5, 0.00, 18000, 0, 0, 0.00, 0.00, NULL, '2025-06-24'),
(5, 8, 0.00, 18000, 0, 0, 0.00, 0.00, NULL, '2025-06-24');
...
--
ALTER TABLE `workingsession`
  MODIFY `working_session_id` int(11) NOT NULL AUTO_INCREMENT;
